	...
	while(!lost){
		...
		*/
		...
		if ( freq > 35 )
			...
			T_period = 1.0/freq;
			iCmd = 0.2*sin(2*3.141592*(cnt)/SAMPLE_RATE/T_period);
		}
		...
		*/
		...
		num[1] = iCmd; //eta1; //test_v_prev; //feedforwardVal; //pCmd; //eta2; //obj.theta; //vnum[0]; //obj.theta; //vel; //obj.theta;
