...
//const double OBJ_X_OFFSET = 0.102447662745; // in m. It may be better to get this value from constant speed control
//const double OBJ_Y_OFFSET = -0.88695933575;  // in m. currently not use this.
...
/* The values for control gains K1 and K2 are multiplied by sig1
   because in this code, \dot\eta_2 = u (not \sigma_1 u like in the paper)*/
#define GAIN_K1			(4.2) 
#define GAIN_K2			(6.0) 
#define GAIN_C			(10.0)  
...
void SampleLoopTask::Task(){
	...
	double OBJ_X_OFFSET_prev = OBJ_X_OFFSET; // test
