...
void SampleLoopTask::Task(){
	...
	while(!lost){
		...
		*/
		...
		double T_period = 0.2;
		//aCmd = 1*DEG2RAD*(2*3.141592/T_period)*(2*3.141592/T_period)*sin(2*3.141592*(cnt)/SAMPLE_RATE/T_period);
		if (cnt == 1) {
		...
		num[1] = pCmd; //eta2; //obj.theta; //vnum[0]; //obj.theta; //vel; //obj.theta;
		num[2] = vCmd; //obj.angVel; //obj.x; //vnum[1]; //obj.x1; //ampVCmd; //obj.x1; // position in m, *10 for cm
