...
#define rid 45   //Since at the beginning the data seems to be a little unstable, so get 'rid' of the first # data.

#define framecnt 75000//int(FRAMERATE*Time_to_record + rid)
#define err 20
